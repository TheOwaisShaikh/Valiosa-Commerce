...
const FBAWholesale = ({navigation}) => {
  ...
  const [whatsAppMsg, setWhatsAppMsg] = useState(
    'Hello Team Valiosa, I need consultancy',
  );
              ...
              <View
                ...
                <View
                  ...
                  <TouchableOpacity
                    onPress={() => navigation.navigate('Product')}>
                    <Image
                      source={require('./../assets/saad.jpg.jpeg')}
                      style={{
                        height: 125,
                        width: 125,
                        marginTop: 2.5,
                ...
                <View
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      onPress={() => navigation.navigate('Product')}>
                      <Image
                        source={require('./../assets/sameer.jpg.jpeg')}
                        style={{
                          height: 125,
                          width: 125,
                          marginTop: 2.5,
